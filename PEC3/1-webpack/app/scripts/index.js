// Se importa la p谩gina de estilos
...
const App = {
  start: function () {
    ...
    // Bootstrap de todas las instancias para su uso. Se hace en todos los m茅todos.
  ...
  refreshBalance: function () {
   setInterval(function() {
    ...
    // Se fuerza refresco de balance continuo en 谩rea proveedor
    ...
    // Se fuerza refresco de balance continuo en 谩rea cliente
    JCLCoin.deployed().then(function (instance) {
	meta2 = instance
